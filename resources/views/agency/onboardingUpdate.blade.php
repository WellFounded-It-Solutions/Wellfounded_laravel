        ...
        <div class="col-xl-9 col-lg-9 col-md-9 m-auto">
            <div class="card">
                <div class="card-header">
                    <h3>{{ __('Update Agency') }}</h3>
                </div>
                <div class="card-body">
                    <form class="forms-sample" action="{{ route('agency.agencyOnboardingPost') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required value="{{ $user->mobile }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="{{ $user->email }}" name="email" id="exampleInputEmail3"
                                        placeholder="Mobile">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-primary">
                                    ...
                                    <input type="text" class="form-control" name="linkedin"
                                        value="{{ $user['linkedin'] }}" placeholder="https://linkedin.com/company">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-primary">
                                    ...
                                    <input type="text" class="form-control" name="instagram"
                                        value="{{ $user['instagram'] }}" placeholder="https://instagram.com">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-primary">
                                    ...
                                    <input type="text" class="form-control" name="facebook"
                                        value="{{ old('facebook', $user['facebook']) }}" placeholder="input-group-primary">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-primary">
                                    ...
                                    <input type="text" class="form-control" name="skype"
                                        value="{{ old('skype', $user['skype']) }}" placeholder="input-group-primary">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" class="form-control"
                                        value=" {{ old('country', $user['country']) }}" id="exampleInputSalary" placeholder="Country">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
