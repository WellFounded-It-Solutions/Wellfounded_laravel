                    ...
                    <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto">
                            ...
                            <form action="{{url('register')}}" method="post">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Email" name="mobile" value="{{ old('mobile') }}" required>
                                    <i class="fa fa-envelope "></i>
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Mobile" name="email" value="{{ old('email') }}" required>
