...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-8 col-lg-8 col-md-8 m-auto" >
                <div class="card">
                    <div class="card-header"><h3>{{ __('Developer Onboarding Form')}}</h3></div>
                    <div class="card-body">
                        <form class="forms-sample">
                            <!-- <div class="form-group">
                                <label for="exampleInputName1">{{ __('Name')}}</label>
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputMobile" placeholder="Mobile">
                                    </div>
                            </div>
                        </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputSalary" placeholder="Salary">
                                </div>
                                </div>
                            </div>
                            <div class="row">
