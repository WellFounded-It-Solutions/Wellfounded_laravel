            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <p class="card-subtitle">@if($user['tagline']) {{$user['tagline']}} @else Update tagline @endif &nbsp; <a href="{{url('/clients/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i></a></p>
                ...
                <div class="card-body">
                    <small class="text-muted d-block">{{ __('Email')}} &nbsp; &nbsp; <a href="{{url('/clients/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i></a></small>
                    <h6> @if($user->email) {{$user->email}} @else <i>Not available</i> @endif</h6>
                    <small class="text-muted d-block pt-10">Phone &nbsp; &nbsp; <a href="{{url('/clients/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i></a></small>
                    <h6> @if($user->mobile) {{$user->mobile}} @else <i>Not available</i> @endif</h6>
                    <small class="text-muted d-block pt-10">Location &nbsp; &nbsp; <a href="{{url('/clients/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i></a></small>
                    <h6> @if($user->location) {{$user->location}} @else <i>Not available</i> @endif</h6>

                    <small class="text-muted d-block pt-10">Website &nbsp; &nbsp; <a href="{{url('/clients/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i></a></small>
            ...
            <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{url('/client/profile/update')}}?id={{$user->id}}">
                                                                    <i class="trash ik ik-edit"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{url('/clients/profile/update')}}?id={{$user->id}}">
                                                                    <i class="trash ik ik-edit"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('client.deleteDocumentClient')}}?id={{$image->id}}">
                            ...
                            <div class="modal fade" id="documentUpload" tabindex="-1" role="dialog" aria-labelledby="documentUploadLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="forms-sample" action="{{route('client.storeDocumentsClient')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('client.deleteImageClient')}}?id={{$image->id}}">
                                                                    <i class="trash ik ik-trash"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="modal fade" id="imageUpload" tabindex="-1" role="dialog" aria-labelledby="imageUploadLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="forms-sample" action="{{route('client.storeImagesClient')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="forms-sample" action="{{route('client.storeSkillsClient')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('client.deleteSkillClient')}}?id={{$skill->id}}" type="button" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="skilledit_{{$skill->id}}" tabindex="-1" role="dialog" aria-labelledby="skilleditLabel_{{$skill->id}}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Form inside the modal -->
                                            <form class="forms-sample" action="{{route('client.updateSkillsClient')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                ...
                <div class="tab-pane fade" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                    <div class="card-body">
                        ...
                        <a href="{{url('/clients/profile/update')}}?id={{$user->id}}" class="btn btn-success" type="button">Update Profile</a>
