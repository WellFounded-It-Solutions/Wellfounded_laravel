            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img class="avatar" src="<?php $profilePic = \App\Models\ClientOnboarding::where('user_id', Auth::user()->id)->first(); ?>@if($profilePic) {{ asset($profilePic['logo'])}} @endif"
                            alt=""></a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{route('client.profile')}}"><i class="ik ik-user dropdown-icon"></i>
                            {{ __('Profile')}}</a>
