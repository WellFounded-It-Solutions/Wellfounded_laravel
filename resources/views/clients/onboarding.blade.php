...
<div class="row">
    <div class="col-xl-9 col-lg-9 col-md-9 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="{{ route('clients.onboardingPost') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required value="{{ old('website',auth()->user()->website) }}" name="website" id="exampleInputEmail3" placeholder="Website/Profile/Portfolio ">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="organizationType" id="exampleWorkingStatus">
                                    ...
                                    <option value="Freelancing" {{ old('organizationType') == 'Freelancing' ? 'selected' : '' }}>Freelancing</option>
                                </select>
                            </div>
                        </div>
                    </div>
