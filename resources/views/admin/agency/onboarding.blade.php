...
<div class="row">
    <div class="col-xl-9 col-lg-9 col-md-9 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="{{ route('admin.agencyOnboardingPost') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required name="pinCode" class="form-control" value=" {{ old('pinCode', $user['pinCode']) }}" id="pinCode" placeholder="Enter Pin Code">
                            </div>
                        </div>
