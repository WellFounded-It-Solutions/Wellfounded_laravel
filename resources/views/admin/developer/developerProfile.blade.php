                ...
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="{{route('admin.manage_developers')}}">Manage Developers</a>
                        </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <small class="text-muted d-block">{{ __('Headline')}} &nbsp; &nbsp;
                        <a href="{{url('/admin/developer/profile/update')}}?id={{$user->id}}"> <i class="fas fa-edit"></i> </small></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="forms-sample" action="{{route('admin.storeExperience')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{route('admin.deleteDeveloperExperience')}}?id={{$experience->id}}" type="button" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal fade" id="myModal_{{$experience->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{$user->id}}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Form inside the modal -->
                                                <form class="forms-sample" action="{{route('admin.updateExperience')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                                                ...
                                                <div class="modal fade" id="deleteModal2_{{$education->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModal2Label_{{$education->id}}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                                <a href="{{route('admin.deleteDeveloperEducation')}}?id={{$education->id}}" type="button" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal fade" id="education_{{$education->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{$user->id}}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Form inside the modal -->
                                                <form class="forms-sample" action="{{route('admin.updateEducation')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                            ...
                            <div class="modal fade" id="certification" tabindex="-1" role="dialog" aria-labelledby="certification" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Form inside the modal -->
                                            <form class="forms-sample" action="{{route('admin.storeCertification')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$user->id}}" id="">
                                                <div class="form-group">
                                                ...
                                                <div class="modal fade" id="deleteModal3_{{$certification->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel_{{$certification->id}}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                                <a href="{{route('admin.deleteDeveloperCertification')}}?id={{$certification->id}}" type="button" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal fade" id="certification_{{$certification->id}}" tabindex="-1" role="dialog" aria-labelledby="certificationlLabel{{$certification->id}}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Form inside the modal -->
                                                <form class="forms-sample" action="{{route('admin.updateCertification')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="user_id" value="{{$user->id}}" id="">
