        ...
        <div class="row align-items-end">
            <div class="col-lg-6">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('Clients Table')}}</h5>
                        <span>{{ __('Create Update Remove clients')}}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="dt-responsive" style="padding:15px">
                <table id="order-table" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                            <a href="{{route('admin.clientProfile', $user->id)}}/">    {{$user->name}}</a>
                            </td>
                            <td>{{ $user->email}}</td>
                            <td>{{ $user->mobile}}</td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.users.forEach(function(user) {
                        html += '<tr>';
                        html += '<td><a href="/admin/client/profile/'+user.id+'">' + user.name + '</a></td>';
