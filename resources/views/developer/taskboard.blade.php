        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('Taskboard')}}</h5>
                        <span>{{ __('Check Out your New , Ongoing & completed Tasks Here ')}}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                    ...
                    <div class="dd" data-plugin="nestable">
                        <ol class="dd-list">
                            ...
                            <li class="dd-item" data-id="2">
                                <div class="dd-handle">
                                    <h6>{{ __('Meeting')}}</h6>
                                    <p>{{ __('The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero')}}
                                    </p>
                                </div>
                            </li>
                        </ol>
                    ...
                    <div class="dd" data-plugin="nestable">
                        <ol class="dd-list">
                            <li class="dd-item" data-id="1">
                                <div class="dd-handle">
                                    <h6>{{ __('Job title')}}</h6>
                                    <p>{{ __("If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.")}}
                                    </p>
                                </div>
                            </li>
                            <li class="dd-item" data-id="2">
                                <div class="dd-handle">
                                    <h6>{{ __('Event Done')}}</h6>
                                    <p>{{ __('Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical')}}
                                    </p>
                                </div>
                            </li>
                        </ol>
