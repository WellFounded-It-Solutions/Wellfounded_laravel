...
<div class="row">
    <div class="col-xl-9 col-lg-9 col-md-9 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" action="{{ route('developer.onboardingPost') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @csrf <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" required value="{{ auth()->user()->mobile }}" name="mobile" placeholder="Mobile">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" required value="{{ auth()->user()->email }}" readonly id="exampleInputEmail3" name="email">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
