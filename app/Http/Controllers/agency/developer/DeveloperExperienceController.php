...
class DeveloperExperienceController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.developerProfile', $request->user_id)->with('success', 'Experience created successfully.');
    }
    ...
    public function updateExperience(Request $request)
    {
        ...
        return redirect()->route('admin.developerProfile', $request->user_id)->with('success', 'Experience updated successfully.');
    }
