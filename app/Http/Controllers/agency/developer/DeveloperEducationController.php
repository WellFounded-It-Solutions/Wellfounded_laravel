...
class DeveloperEducationController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.developerProfile', $request->user_id)->with('success', 'Education created successfully.');
    }
    ...
    public function updateEducation(Request $request)
    {
        ...
        return redirect()->route('agency.developerProfile', $request->user_id)->with('success', 'Education updated successfully.');
    }
