...
namespace App\Http\Controllers\agency\developer;

use App\Http\Controllers\agency\BaseController;
...
class DeveloperCertificationController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.developerProfile', $request->user_id)->with('success', 'Certification created successfully.');
    }
    ...
    public function updateCertification(Request $request)
    {
        ...
        return redirect()->route('agency.developerProfile', $request->user_id)->with('success', 'Certification updated successfully.');
    }
